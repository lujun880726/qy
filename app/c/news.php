 ...
 */
class c_news extends c_cabstract
{
    ...
    public function indexAction()
    {
        ...
        return array('listNews' => $listNews, 'page' => $page, 'cnt' => ceil($count / $pageSize), 'p' => 6);
    }
